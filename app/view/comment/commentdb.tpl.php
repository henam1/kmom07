...
<h4><a href="<?= $this->url->create('comment/update/'.$comment->id) ?> "title="Editera kommentar" class="id">#<?=$comment->id?></a></h4>
...
<a href='comment/update/<?=$comment->id?>' class="pull-right"><button >Editera</button></a>    
