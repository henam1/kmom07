...
return [
    ...
    'views' => [
            ...
            ['region' => 'header', 'template' => 'me/header', 'data' => [
                'siteTitle' => "All about Gothenburg",
                'siteTagline' => "Everything you need to know about Gothenburg",
                                                                             ], 
             'sort' => -1],
    ...
    'data' => [
        ...
        'title_append' => ' | All about Gothenburg',

        // Stylesheets
        'stylesheets' => ['css/style.css', 'css/navbar_me.css', 'css/anax-grid/font-awesome-4.2.0/css/font-awesome.min.css'],
